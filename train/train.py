...
class Trainer:
    ...
    def __init__(self, config: Dict[str, Any], model_config: ModelConfig):
        ...
        self.is_main_process = (not self.is_ddp) or (self.local_rank == 0)
        ...
        # Get raw model for saving/param access
        self.raw_model = self.model.module if self.is_ddp else self.model
        ...
        self.warmup_steps = config.get('warmup_steps', max(100, self.max_steps // 20))
    ...
    def train(self):
        ...
        tokens_per_step = self.effective_batch_size * self.model_config.block_size
        ...
        while self.step < self.max_steps:
            ...
            if self.step % self.eval_interval == 0 and self.is_main_process:
                ...
                if is_best:
                    ...
                    self.save_checkpoint(self.checkpoint_dir / f'step_{self.step}.pt', is_best=True)
